                            ...
                            <ul class="nav-main nav-main-horizontal nav-main-hover ">
                                ...
                                <li class="nav-main-item">
                                    ...
                                    <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name">Stock card :: คลังย่อย</span>
                                    </a>
                                    <ul class="nav-main-submenu">
                                        <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_warehouse/treasury') }}">
                                                <span class="nav-main-link-name loadscreen">คลังย่อย รพ.</span>
                                            </a>
                                        </li>
                                        <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_warehouse/treasury_small') }}">
                                                <span class="nav-main-link-name loadscreen">คลังย่อย รพ.สต.</span>
                                            </a>
                                        </li>  
                                    ...
                                    <ul class="nav-main-submenu">
                                        ...
                                        <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_warehouse/disbursesmall') }}">
                                                <span class="nav-main-link-name loadscreen">เบิกจ่ายวัสดุ รพ.สต.</span>
                                            </a>
                                        </li>  
                                ...
                                <li class="nav-main-item">
                                    ...
                                    <ul class="nav-main-submenu">
                                        ...
                                        <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_warehouse/reportcheckmin') }}">
                                                <span class="nav-main-link-name loadscreen">รายงานวัสดุที่ต้องจัดซื้อ</span>
                                            </a>
                                        </li>
                                        {{-- <li class="nav-main-item">
                                ...
                                <li class="nav-main-item">
                                    ...
                                    <ul class="nav-main-submenu">
                                        ...
                                        <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_warehouse/warehousesetquotadep') }}">
                                                <span class="nav-main-link-name loadscreen">กำหนดโควตาของคลังย่อย</span>
                                            </a>
                                        </li>
