...
//====================================ดึงรายการจากโควตา
function infoquota(Request $request,$iduser,$id_all)
{
    ...
    $detailquota = DB::table('warehouse_treasury_quota')
    ->leftJoin('warehouse_store','warehouse_treasury_quota.WAREHOUSE_TREASARY_QUOTA_SUP_CODE','=','warehouse_store.STORE_CODE')
    ->leftJoin('supplies_unit_ref','warehouse_store.STORE_UNIT','=','supplies_unit_ref.ID')
    ->where('WAREHOUSE_TREASARY_QUOTA_DEP_ID','=',$inforpersonuser->HR_DEPARTMENT_SUB_SUB_ID)->get();

    $checkdetail = DB::table('warehouse_treasury_quota')->where('WAREHOUSE_TREASARY_QUOTA_DEP_ID','=',$inforpersonuser->HR_DEPARTMENT_SUB_SUB_ID)->count();
