...
Route::get('manager_warehouse/reportcheckmin','ManagerwarehouseController@reportcheckmin')->name('mwarehouse.reportcheckmin'); //รายงานวัสดุที่ต้องจัดซื้อ
//=====ฟังชั่นเสริม
...
Route::get('general_warehouse/infoquota/{iduser}/{id_all}','WarehouseController@infoquota')->name('warehouse.infoquota'); //ดึงรายการจากการกำหนดโควตา
...
Route::get('manager_warehouse/treasury_small/{small_id?}','ManagerwarehouseController@treasury_small')->name('mwarehouse.treasury_small');
Route::get('manager_warehouse/treasury_small/detail/{small_id}','ManagerwarehouseController@treasury_small_detail')->name('mwarehouse.treasury_small_detail');
...
//------------------------โควต้าจ่ายของหน่วยงาน 
Route::get('manager_warehouse/warehousesetquotadep', 'ManagerwarehouseController@warehousesetquotadep')->name('mwarehouse.setquotadep');
Route::get('manager_warehouse/warehousesetquotadep_setquota/{idref}', 'ManagerwarehouseController@warehousesetquotadep_setquota')->name('mwarehouse.warehousesetquotadep_setquota');
Route::post('manager_warehouse/savewarehousesetquotadep_setquota','ManagerwarehouseController@savewarehousesetquotadep_setquota')->name('mwarehouse.savewarehousesetquotadep_setquota');
//-------เพิ่มการขอเบิกพัสดุ
...
Route::get('formpdf/warehouse_10978/{id}/{iduser}','FormpdfController@warehouse_10978')->name('form.warehouse_10978');
